...
// --    Box(int _Id, BoxType _Type, int _RBIdx=-1, RigidBody const *_pRB=NULL, bool _Fixed=false) :
// --      aId(_Id), aType(_Type), aRBIdx(_RBIdx), apRB(_pRB),
...
// --    };
// --
// --    inline RigidBody const * getRigidBody() const {
// --      return apRB;
// --    };
// --    inline int getRigidBodyIdx() const {
// --      return aRBIdx;
// --    };
// --
// --
...
// --    BoxedVrtx(int _Id, int _RBIdx, RigidBody const *_RB, bool _Fixed, Vector2s const &_X, double const &_R) : 
// --      Box(_Id, E_VrtxBox, _RBIdx, _RB, _Fixed), aX(_X[0]), aY(_X[1]) {
// --        updateR(_R);
// --        changed();
// --      };
// --
...
// --    BoxedEdge(int _Id, int _RBIdx, RigidBody const *_RB, BoxedVrtx *_A, BoxedVrtx *_B, double const &_R) : 
// --      Box(_Id, E_EdgeBox, _RBIdx, _RB, false), aVrtx(_A, _B) {
// --        updateR(_R);
// --        changed();
// --      };
// --
...
// --
// --    inline void init(T_RBCntr const &_RBs) {
// --      boxObjs(_RBs);
// --    };
// --    void update(T_RBCntr const &);
// --
// --    inline bool findIntersect(T_IntersCntr &_PP, T_IntersCntr &_PE, T_IntersCntr &_PH) {
...
// --  private:
// --
// --    void boxVrtxs(T_RBCntr const &);
// --    void boxEdges(T_RBCntr const &);
// --    void boxHalfP(T_RBCntr const &);
// --    void boxObjs(T_RBCntr const &);
// --    
...
// --    };
// --
// --    void updateVrtx(T_RBCntr const &, VectorXs const &, BoxedVrtx &);
// --    void updateEdge(T_RBCntr const &, BoxedEdge &);
// --
// --
// --  private:
// --
...
// -- * Boxes scene objects.
// -- */
// --void BoxedScene::boxVrtxs(T_RBCntr const &_RBs)
// --{
// --}
// --
// --
...
// -- * Boxes scene objects.
// -- */
// --void BoxedScene::boxEdges(T_RBCntr const &_RBs)
// --{
// --}
// --
// --
...
// -- * Boxes scene objects.
// -- */
// --void BoxedScene::boxHalfP(T_RBCntr const &_RBs)
// --{
// --}
// --
// --
...
// -- * Boxes scene objects.
// -- */
// --void BoxedScene::boxObjs(T_RBCntr const &_RBs)
// --{
// --}
// --
// --
...
// --
// --
// --void BoxedScene::updateVrtx(T_RBCntr const &_RBs, VectorXs const &_X, BoxedVrtx &_O)
// --{
// --};
// --
// --
// --void BoxedScene::updateEdge(T_RBCntr const &_RBs, BoxedEdge &_O)
// --{
// --};
// --
// --
...
// -- */
// --void BoxedScene::update(T_RBCntr const &_RBs)
// --{
// --}
// --
// --
...
/**********************************************************************************
 * ################################################################################
 * Local collision detection related functions.
 */



static bool detectParticleEdge(
    RigidBody const &_A, 
    RigidBody const &_B, 
    Vector2s const &_X1,
    Vector2s const &_X2,
    ...
    scalar &_D)
{
    ...
    if (bTouch) {
      ...
      //_R0 = _X1 - _A.getX();
      //_R1 = Xn - _B.getX();
      //_R0 = (_X1-_N*R0) - _A.getX();
      //_R1 = (Xn+_N*R1) - _B.getX();
...
/**********************************************************************************
 * ################################################################################
 * Local all-in collisions support functions
 */
...
void checkCollision(
    ...
    RigidBody const &_A, 
    RigidBody const &_B, 
    T_IntersSet const &_VEPairs,
    T_Collisions &_Collisions)
{
  ...
  for (; I != _VEPairs.end(); ++I) {
    Vector2s X1 = _A.getWorldSpaceVertex(I->first);
    Vector2s X2 = _B.getWorldSpaceVertex(I->second);
...
static void allIn(
    ...
    T_Collisions &_Collisions)
{
  int RBsNum = _RBs.size();
  T_IntersSet RBPairs, VEPairs;

  combination(RBsNum, RBPairs);
  T_IntersSet::const_iterator I = RBPairs.begin();
  for (; I != RBPairs.end(); ++I) {
    RigidBody const &A = _RBs[I->first];
    RigidBody const &B = _RBs[I->second];
    VEPairs.clear();
    combination2(A.getNumVertices(), B.getNumEdges(), VEPairs);
    checkCollision(I->first, I->second, A, B, VEPairs, _Collisions);
    VEPairs.clear();
    combination2(B.getNumVertices(), A.getNumEdges(), VEPairs);
    checkCollision(I->second, I->first, B, A, VEPairs, _Collisions);
  };
}
 ...
 */
static void initEuler(T_RBCntr const &_RBs)
{
 ...
 */
static void initLagr(T_RBCntr const &_RBs)
{
}
 ...
 */
static AlgoEnum evaluateScene(T_RBCntr const &_RBs, bool &_First)
{
  return AllInAlgo;
}
...
void RigidBodyAllPairsCollisionDetector::detectCollisions( const std::vector<RigidBody>& rbs, std::set<RigidBodyCollision>& collisions )
{
  ...
  switch(evaluateScene(rbs, bFirst)) {
    ...
    case LagrAlgo:
      estimateLagr(bFirst, rbs, collisions);
      break;
