#include "RigidBodyGRLCPCollisionResolver.h"

void RigidBodyGRLCPCollisionResolver::resolveCollisions( std::vector<RigidBody>& rbs, const std::set<RigidBodyCollision>& rbcs )
{
  // Your code goes here!
